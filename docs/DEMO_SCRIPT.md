...
Demo command flow — the 3 min 7 sec video (https://youtu.be/ifMU-fvNbVk) presents a tight cut of this sequence; every command was exercised live in one continuous session.
